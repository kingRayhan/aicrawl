          ...
          if (!metadata && jsonLdElement.getAttribute("type") === "application/ld+json") {
            try {
              ...
              if (typeof parsed.name === "string" && typeof parsed.headline === "string" && parsed.name !== parsed.headline) {
                var title2 = this._getArticleTitle();
                var nameMatches = this._textSimilarity(parsed.name, title2) > 0.75;
                var headlineMatches = this._textSimilarity(parsed.headline, title2) > 0.75;
...
// .wrangler/tmp/bundle-d7QGHx/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_performance2();

// .wrangler/tmp/bundle-d7QGHx/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_performance2();
  ...
  route(path, app2) {
    ...
    app2.routes.map((r) => {
      ...
      if (app2.errorHandler === errorHandler) {
        ...
        handler4 = /* @__PURE__ */ __name(async (c, next) => (await compose([], app2.errorHandler)(c, () => r.handler(c, next))).res, "handler");
...
// node_modules/linkedom/esm/mixin/parent-node.js
var isNode = /* @__PURE__ */ __name((node) => node instanceof Node4, "isNode");
...
function __facade_invokeChain__(request, env2, ctx, dispatch2, middlewareChain) {
...
function __facade_invoke__(request, env2, ctx, dispatch2, finalMiddleware) {
  return __facade_invokeChain__(request, env2, ctx, dispatch2, [
